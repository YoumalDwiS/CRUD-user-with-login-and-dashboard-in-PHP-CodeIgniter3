                   ...
                   <div class="col-lg-8 col-md-7">
                        <div class="card">
                            <div class="card-block">
                                ...
                                <form role="form" action="<?php echo base_url().'user_lihat/update'; ?>" method="post">
                                    <div class="box-body">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" name="pass" id="pass" value="<?php echo $u->password ?>" required>
                                        </div>
                                        <div class="form-group">
                                            <label for ="role">Role</label>
                                            <select style="width:100%;" class="form-control" name="role" value="<?php echo $u->role ?>"required>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" name="email" value="<?php echo $u->email ?>" required>
                                        </div>
                                        <div class="form-group">
                                            <label for ="telepon">Telepon</label>
                                            <input type="text" class="form-control" name="telepon" value="<?php echo $u->telepon ?>" required>
                                        </div>
                                        <button type="submit" class="btn btn-default pull-left" data-dismiss="modal">Batal </button>
                                        &nbsp;&nbsp;

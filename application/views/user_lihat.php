                                ...
                                <tbody>
                                    ...
                                    <?php foreach ($user as $u) {?>
                                        <tr>
                                            ...
                                            <td>
                                                    <a href="<?php echo site_url('user_lihat/edit/'.$u->username) ?>" class="btn btn-success">Edit</a>
                                                </td>
                                                <td>
                                                    <a href="<?php echo site_url('user_lihat/hapus/'.$u->username) ?>" class="btn btn-danger" onclick="return confirm('Yakin ingin menghapus?');">Hapus</a> 
                                                </td>
                                        </tr>
                                 <?php   } ?>
                                </tbody>
